                            ...
                            int M, int N, int K)
{
    ...
    for (int t = 0; t < (K + TILE - 1) / TILE; t++) {
         ...
         * ══════════════════════════════════════════════════════ */
        tA[threadIdx.y][threadIdx.x] = 0.0f;  /* <-- replace */
         ...
         * ══════════════════════════════════════════════════════ */
        tB[threadIdx.y][threadIdx.x] = 0.0f;  /* <-- replace */
...
void diy_gemm_benchmark(cublasHandle_t handle)
{
    ...
    for (int s = 0; s < n_sizes; s++) {
        ...
        /* YOUR CODE for tiled_ms and cublas_ms */
                           ...
                           int N, int C, int H, int W)
{
     ...
     * ══════════════════════════════════════════════════════════ */
    output[((n*C + c)*H_out + oh)*W_out + ow] = 0.0f;  /* <-- replace */
}
                               ...
                               int N, int C, int HW, float eps)
{
    ...
    for (int n = 0; n < N; n++) {
         ...
         * ══════════════════════════════════════════════════════ */
        out[idx] = x[idx];  /* <-- replace with normalized value */
    }
}
                             ...
                             int strideH, int strideW)
{
     ...
     * ══════════════════════════════════════════════════════════ */
    output[((n*C_out + oc)*H_out + oh)*W_out + ow] = 0.0f;  /* <-- replace */
}
